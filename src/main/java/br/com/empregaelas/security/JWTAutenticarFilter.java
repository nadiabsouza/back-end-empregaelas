package src.main.java.br.com.empregaelas.security;
...
public class JWTAutenticarFilter extends UserNameEásswprdAutheticationFilter{
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            return authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(
                   ...
                   //Obs.: falta acrescentar abaixo as permissões do usuário.
                    new ArrayList<>()
            ));
