...
public class VagasVO implements Serializable{
	...
	@Override
	public int hashCode() {
		return Objects.hash(publicada,dataPublicacao,cargo,nivel,jornada,salario,tipoContrato,modalidade,descricaoVaga,requisitos,desejavel,beneficios,uf,cidade,bairro,cep,exibirEmpresa); 
	}
		@Override
